            ...
            <ul class="nav navbar-nav">
              ...
              <!--  <li class="dropdown messages-menu">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <a href="{{URL::to('messages')}}" class="dropdown-toggle" data-toggle="dropdown">
                         Messages <i class="fa fa-envelope-o">  <span class="badge">@include('messenger.unread-count')</span></i> 
                    </a>

                    <ul class="dropdown-menu">
                        <li class="header">{{ trans_choice('strings.backend.general.you_have.notifications', 0) }}</li>
                        <li class="footer">
                            {{ link_to('messages', trans('strings.backend.general.see_all.notifications')) }}
                        </li>
                    </ul>
