                ...
                <div class="panel-body">
                    ...
                    <div role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                             ...
                             <li role="presentation" class=" ">
                                <a href="#supervisors_and_Mentors" aria-controls="profile" role="tab" data-toggle="tab">{{ trans('Manage supervisors and Mentors') }}</a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane mt-30" id="supervisors_and_Mentors">
                                @include('frontend.user.account.tabs.supervisors_and_Mentors')
                            </div>
